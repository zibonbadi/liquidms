...
class NetgameModel
{
    ...
    public static function changeServer($op = 1, $ip = null, $port = '5029', $title = 'SRB2 server', $version = '2.2.10', $roomname = null)
    { //Operation, Host, port, servername, version, roomname.
