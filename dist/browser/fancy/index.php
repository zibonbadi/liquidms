    ...
    <template data-name="netgame">
        ...
        <div>
            ...
            <div class="flex">
                ...
                <ul>
                    <li><span name="version">DummyBuild</span> (<span name="version_name">SRB2</span> <span
                                name="version_major">X</span> <span name="version_minor">Y</span> <span
                                name="version_patch">Z</span>)
                    </li>
...
<?php if (in_array('v1', $this->sharedData()->get('modules'))) { ?>
    ...
    <ol>
        ...
        <li>Server</li>
        <li>Master Server: <a
                    href="<?php echo "http://{$_SERVER['SERVER_NAME']}/v1"; ?>"><?php echo "http://{$_SERVER['SERVER_NAME']}/v1"; ?></a>
        </li>
    </ol>
    </p>
<?php } ?>
